function openModal() {
    ...
    confirmMyInput.onkeyup  = function() {
                ...
                //var passEqualsConfPass = (match); // TODO: Change this to the condition that needs to be checked so that the text entered in password equals the text in confirm password
                if(myInput.value!="" && confirmMyInput.value!=""){
                    if(myInput.value==confirmMyInput.value) {
                    match.classList.remove("invalid");
                    match.classList.add("valid");
